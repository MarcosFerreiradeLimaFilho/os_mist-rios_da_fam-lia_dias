...
public class Thing extends BaseThing implements java.io.Serializable {
    ...
    protected String article(String s) {
        ...
        caractere_final = (s.toLowerCase()).charAt(s.length() - 1);
        
        if (caractere_final == 'o')  {
            a = "o";
        }
        else if (caractere_final == 'l')  {
            a = "o";
        } 
        else {
            a = "a";    
    ...
    public String open() {
        return "Não posso abrir " + getDescription() + " porque não é um contêiner.";
    }

    public String close() {
        return "Não posso fechar " + getDescription() + " porque não é um contêiner.";
    }

    public String describe() {
        String d;
        d = getLongDescription();
        // char artigo = article(d).charAt(0);
